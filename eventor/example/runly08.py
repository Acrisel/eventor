...
#ev=evr.Eventor(store=':memory:', logging_level=logging.DEBUG, config={'sleep_between_loops': 5})
ev=evr.Eventor(logging_level=logging.DEBUG, config={'sleep_between_loops': 5})
...
ev.add_assoc(ev2s, s2, delay=20)
ev.add_assoc(ev3s, s3, delay=30)
