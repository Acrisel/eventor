...
About
=========
:synopsis:     commandline  handler for existing eventor db
:moduleauthor: Arnon Sela @ acrisel.com
:date:         Nov 26, 2016
:description:  cmd provides access to set of commands to manipulate eventor db.  
               This would be done after a run and before rerun.
...
Example to run on the command line::
    ...
    running_module.py //some/url some.other.argument 
